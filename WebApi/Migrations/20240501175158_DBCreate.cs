        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Image_URL_S = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Image_URL_M = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Image_URL_L = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookISBN = table.Column<string>(type: "nvarchar(10)", nullable: false),
